...
const RegistroMunicipe = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSend = {
      ...
      password,
      tipo: "Municipe",
      cpf, // Directly sending the cpf here
    };
    ...
    try {
      await axios.post(`${apiBaseUrl}/Usuarios/registrar-municipe`, dataToSend);
      alert("Munícipe cadastrado com sucesso!");
      navigate("/"); // Navigate to a different page (e.g., home or list)
    } catch (error) {
      alert("Erro ao cadastrar munícipe.");
      console.error(error);
  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit} className="form">
        ...
        <label>CPF: <input value={cpf} onChange={e => setCpf(e.target.value)} required /></label>
...
export default RegistroMunicipe;
